...
function test_report(url, auth, auth_cb, timeout, async_job_check_time_ms, service_version) {
    var self = this;
    ...
    var _auth_cb = auth_cb;
     ...
     this.run_test_report = function (params, _callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "test_report.run_test_report",
    ...
    this.status = function (_callback, _errorCallback) {
        ...
        return json_call_ajax(_url, "test_report.status",
